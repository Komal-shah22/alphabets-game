...
let secondName: number[] = [];
let firstNames: string[] = [];
let secondNames: string[] = [];
let finalNames: string[] = [];
let sample1: string = "AEIMQUY";
let sample2: string ="BFJNRVZ" ;
let sample3:string = "CGKOSW";
let sample4: string = "DHLpTX";
...
for(let i=1; i<=responce.arr;i++){
    let ordinal: string = `${i}`
    switch(ordinal){
        case"1" || "21" || "31":ordinal=`${1}st`;break;
        case"2" || "22" || "32":ordinal=`${1}nd`;break;
        case"3" || "23" || "33":ordinal=`${1}rd`;break;
        default:ordinal = `${1}th`;break;
    }
...
let first:string = ("A E I M Q U Y")
let second:string =("B F J N R V Z")
let third:string = ("C G K O S W")
let forth:string = ("D H L P T X")
firstName.forEach((val) =>{
    switch (val){
        case 1: firstNames.push(first); secondNames.push(sample1); break;
        case 2: firstNames.push(second); secondNames.push(sample2); break;
        case 3: firstNames.push(third); secondNames.push(sample3); break;
        case 4: firstNames.push(forth); secondNames.push(sample4); break;
        default :return null;
    }
});
...
for(let i = 1;i<=responce.arr;i++){
    let ordinal:string=`${i}`
    switch(ordinal){
        case "1" || "21" || "31":ordinal = `${i}st`; break;
        case "2" || "22" || "32":ordinal = `${i}nd`; break;
        case "3" || "23" || "33":ordinal = `${i}rd`; break;
...
let name:string = finalNames.join("")
